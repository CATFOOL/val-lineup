<template>
      ...
      <div class="space-y-6">
        <div class="bg-gray-800 rounded-lg p-6">
          ...
          <div class="flex flex-wrap gap-2 mb-4">
            ...
            <span
              v-if="lineup.side"
              class="bg-gray-700 text-white text-sm px-3 py-1 rounded capitalize"
            >
              {{ lineup.side }}
            </span>
          ...
          <div
            class="flex items-center justify-between text-sm text-gray-400 pt-4 border-t border-gray-700"
          >
            <NuxtLink
  ...
  <div v-else class="text-gray-400">Loading lineup...</div>
